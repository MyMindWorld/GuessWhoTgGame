...
class UserService @Autowired constructor(
    ...
    fun findUser(message: Message): User =
        userRepository.findById(message.from!!.id)
            .orElseThrow { IllegalStateException("User was not found in db!") }
    ...
    fun checkUserNotInGame(user: User, bot: Bot, message: Message) {
